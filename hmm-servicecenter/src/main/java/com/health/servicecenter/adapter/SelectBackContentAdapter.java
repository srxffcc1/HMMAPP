...
public class SelectBackContentAdapter extends RecyclerView.Adapter<SelectBackContentAdapter.ViewHolder> {
    private Context mContext;
    private int mPosition = -1;
    private SetListener getListener;
    private List<String> list = new ArrayList<>();

    public SelectBackContentAdapter(Context mContext, List<String> list) {
    ...
    @NonNull
    @Override
    public SelectBackContentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.dialog_select_back_content_layout, parent, false);
        return new SelectBackContentAdapter.ViewHolder(view);
    }
