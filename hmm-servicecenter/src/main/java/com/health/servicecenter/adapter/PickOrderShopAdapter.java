...
public class PickOrderShopAdapter extends BaseQuickAdapter<GoodsShop, BaseViewHolder> {
    ...
    public PickOrderShopAdapter() {
        this(R.layout.item_pick_shop);
    }


    private PickOrderShopAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, final GoodsShop item) {
        ...
        tvShopAddress.setText(item.shopAddress);
    ...
    public interface OnShopClickListener {
        void onShopClick(GoodsShop goodsShop);
    }
}
