...
public class OrderListFragmentPresenter implements OrderListFragmentContract.Presenter {

    private Context mContext;
    private OrderListFragmentContract.View mView;

    public OrderListFragmentPresenter(Context context, OrderListFragmentContract.View view) {
        mContext = context;
        mView = view;
    }
    ...
    public void getOrderList(Map<String, Object> map) {
        map.put(Functions.FUNCTION, "25005");
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new NoStringObserver(mView, mContext, false) {
                    @Override
                    protected void onGetResultSuccess(String obj) {
                        super.onGetResultSuccess(obj);
                        mView.onGetOrderListSuccess(resolveOrderData(obj), resolveOrderPagData(obj));
                    }
    ...
    private List<OrderList> resolveOrderData(String obj) {
        ...
        try {
            ...
            Type type = new TypeToken<List<OrderList>>() {
            }.getType();
    ...
    private OrderListPageInfo resolveOrderPagData(String obj) {
        OrderListPageInfo result = null;
        try {
