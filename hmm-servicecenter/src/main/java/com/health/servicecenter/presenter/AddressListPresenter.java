...
public class AddressListPresenter implements AddressListContract.Presenter {
    ...
    public AddressListPresenter(Context context, AddressListContract.View view) {
        mContext = context;
        mView = view;
    }
        ...
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false) {
                    ...
                    protected void onGetResultSuccess(String obj) {
                        ...
                        mView.onGetAddressListSuccess(resolveData(obj));
                    }
    ...
    private List<AddressListModel> resolveData(String obj) {
