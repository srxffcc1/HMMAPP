...
public class NearbyStorePresenter implements NearbyStoresContract.Presenter {

    private Context mContext;
    private NearbyStoresContract.View mView;

    public NearbyStorePresenter(Context context, NearbyStoresContract.View view) {
        mContext = context;
        mView = view;
    }
