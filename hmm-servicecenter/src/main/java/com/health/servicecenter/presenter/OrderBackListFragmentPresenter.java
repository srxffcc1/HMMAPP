...
public class OrderBackListFragmentPresenter implements OrderBackListFragmentContract.Presenter {
        ...
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false) {
                    ...
                    protected void onGetResultSuccess(String obj) {
                        ...
                        mView.onGetBackListSuccess(resolveStoreData(obj), resolveOrderPagData(obj));
                    }
    ...
    @Override
    public void revokeOrder(String id) {
        Map<String, Object> map = new HashMap<>();
        map.put("refundId", id + "");
        map.put(Functions.FUNCTION, "25009");
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false) {
                    @Override
                    protected void onGetResultSuccess(String obj) {
                        super.onGetResultSuccess(obj);
                        try {
                            mView.onRevokeOrderSuccess(new JSONObject(obj).getString("msg"));
    ...
    public void deleteOrder(String id) {
        Map<String, Object> map = new HashMap<>();
        map.put("refundId", id + "");
        map.put(Functions.FUNCTION, "25010");
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false) {
                    @Override
                    protected void onGetResultSuccess(String obj) {
    ...
    private List<BackListModel> resolveStoreData(String obj) {
        List<BackListModel> result = new ArrayList<>();
        try {
            ...
            Type type = new TypeToken<List<BackListModel>>() {
            }.getType();
