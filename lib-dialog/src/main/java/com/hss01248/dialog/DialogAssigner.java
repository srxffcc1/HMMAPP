...
public class DialogAssigner implements Assignable {
    ...
    @Override
    public ConfigBean assignBottomItemDialog(Context context, List<? extends CharSequence> words, List<? extends Integer> wordscolors, CharSequence bottomTxt, MyItemDialogListener listener) {
        ConfigBean bean = new ConfigBean();
        bean.context = context;
        bean.itemListener = listener;
        bean.wordsIos = words;
        bean.wordsIosColors = wordscolors;
        bean.type = DefaultConfig.TYPE_IOS_BOTTOM;
        bean.gravity = Gravity.BOTTOM;
        bean.bottomTxt = bottomTxt;
        bean.titleTxtColor = R.color.dialogutil_ios_btntext_blue;
...
//        bean.viewHolder = new MdInputHolder(ActivityStackManager.getInstance().getTopActivity());
    ...
    @Override
    public ConfigBean buildMdInput(CharSequence title, CharSequence hint1, CharSequence hint2, CharSequence inputText1, CharSequence inputText2, InputFilter[] digits1, InputFilter[] digits2, MyDialogListener listener) {
        ConfigBean bean = new ConfigBean();
        bean.type = DefaultConfig.TYPE_MD_INPUT;
        bean.listener = listener;
        bean.title = title;
        ...
        bean.inputText1 = inputText1;
        bean.inputText2 = inputText2;
        bean.digits1=digits1;
        bean.digits2=digits2;
        //bean.viewHolder = new MdInputHolder(ActivityStackManager.getInstance().getTopActivity());
        return bean;
    }
