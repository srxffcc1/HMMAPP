...
public class StyledDialog {
    ...
    public static void init(Context context) {
       ...
       /* String userAgent = System.getProperty("http.agent");
        ...
        mainHandler = new Handler(Looper.getMainLooper());
        DefaultConfig.initBtnTxt(weakReference.get());
    }
    ...
    public static ConfigBean buildBottomItemDialog(List<? extends CharSequence> words,List<? extends Integer> wordscolors, CharSequence bottomTxt, MyItemDialogListener listener) {
        return DialogAssigner.getInstance().assignBottomItemDialog(null, words, wordscolors,bottomTxt, listener);
    }
    ...
    public static ConfigBean buildMdInput(CharSequence title, CharSequence hint1, CharSequence hint2,
                                          CharSequence inputText1, CharSequence inputText2, InputFilter[] dig1, InputFilter[] dig2, MyDialogListener listener) {
        return DialogAssigner.getInstance().buildMdInput(title, hint1, hint2, inputText1, inputText2, dig1,dig2,listener);
