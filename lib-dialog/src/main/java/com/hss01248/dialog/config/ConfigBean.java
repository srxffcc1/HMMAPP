...
public class ConfigBean extends MyDialogBuilder implements Styleable {
    ...
    public InputFilter[] digits1;
    public InputFilter[] digits2;
    ...
    public List<? extends Integer> wordsIosColors;
    //bottom sheet
...
支持gridview 或者recylerview*/
    ...
    /**
     * default background res: R.drawable.dialogutil_shadow,white background ,surround with dialogutil_shadow
     *
     * @param useTheWhiteAndShadowBg default is true. set false to disable the dialogutil_shadow background ,and set your own background in your xml
     * @return
     */
