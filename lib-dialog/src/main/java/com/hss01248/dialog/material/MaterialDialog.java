    ...
    private class Builder {
        ...
        private Builder() {
            ...
            View contentView = LayoutInflater.from(mContext)
                                             .inflate(R.layout.dialogutil_layout_material_dialog, null);
            contentView.setFocusable(true);
            contentView.setFocusableInTouchMode(true);

            mAlertDialogWindow.setBackgroundDrawableResource(R.drawable.dialogutil_material_dialog_window);
        ...
        /**
         * set positive dialogutil_button
         *
         * @param text the name of dialogutil_button
         */
        public void setPositiveButton(String text, final View.OnClickListener listener) {
            ...
            button.setBackgroundResource(R.drawable.dialogutil_material_card);
        ...
        /**
         * set negative dialogutil_button
         *
         * @param text the name of dialogutil_button
         */
