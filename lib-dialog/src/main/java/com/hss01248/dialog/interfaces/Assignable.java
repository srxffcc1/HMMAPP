...
public interface Assignable {
    ...
    ConfigBean assignBottomItemDialog(Context context,List<? extends CharSequence> words,List<? extends Integer> wordscolors, CharSequence bottomTxt,final MyItemDialogListener listener);
   ...
   ConfigBean assignCustom(Context context, View contentView, int gravity);
    ...
    ConfigBean buildMdInput(CharSequence title, CharSequence hint1, CharSequence hint2,
                            CharSequence firstTxt, CharSequence secondTxt, InputFilter[] digits1, InputFilter[] digits2, MyDialogListener listener);
