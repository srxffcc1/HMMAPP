...
//                //System.out.println(buffer.buffer[j + 1]);
//                //System.out.println(buffer.buffer[j + 2]);
//                //System.out.println(buffer.buffer[j + 3]);
//                //System.out.println("----------------------");
                c.drawCircle((buffer.buffer[j]+buffer.buffer[j + 2])/2,buffer.buffer[j + 1],(buffer.buffer[j+2]-buffer.buffer[j])/2,mRenderPaint);
            }
    ...
    public void drawValue(Canvas c, String valueText, float x, float y, int color) {
        ...
        c.drawText(valueText, x, y-10, mValuePaint);
    }
