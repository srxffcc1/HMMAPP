 ...
 * @des
 */
public class ToolsDiaryPresenter implements ToolsDiaryContract.Presenter {

    private Activity mContext;
    private ToolsDiaryContract.View mView;

    public ToolsDiaryPresenter(Activity context, ToolsDiaryContract.View view) {
        mContext = context;
        mView = view;
    }
...
//                        mView.onGetStoreDetailFail();
    ...
    @Override
    public void updateDiary(final Map<String, Object> map) {
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false,
                        true, true, false) {
                    @Override
