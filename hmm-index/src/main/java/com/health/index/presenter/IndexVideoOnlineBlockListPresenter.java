...
import com.health.index.contract.IndexVideoOnlineBlockContract;
 ...
 * @des
 */
public class IndexVideoOnlineBlockListPresenter implements IndexVideoOnlineBlockContract.Presenter {

    private Context mContext;
    private IndexVideoOnlineBlockContract.View mView;

    public IndexVideoOnlineBlockListPresenter(Context context, IndexVideoOnlineBlockContract.View view) {
        mContext = context;
        mView = view;
    }
...
//            e.printStackTrace();
    ...
    private List<IndexVideoOnline> resolveListData(String obj) {
