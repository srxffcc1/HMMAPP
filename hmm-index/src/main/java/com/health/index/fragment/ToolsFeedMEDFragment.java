...
public class ToolsFeedMEDFragment extends ToolsFeedBaseFragment implements ToolsDiaryContract.View {
    ...
    protected int getLayoutId() {
        return R.layout.index_fragment_tools_diary_med;
    }
    ...
    protected void findViews() {
        ...
        if (get("recordId")!= null) {
            toolsDiaryPresenter.getNowDiary(new SimpleHashMapBuilder<String, Object>().puts(Functions.FUNCTION,"9027").puts("recordId",get("recordId").toString()).puts("recordType","4"));
        }else {
...
//        toolsFeedTypeListAdapter.setChoseCount(1);
        ...
        toolsMedTypes.add(new ToolsMedType("D3", "R.drawable.yaopin", "R.drawable.yaopin_w"));
        toolsMedTypes.add(new ToolsMedType("DHA", "R.drawable.yaopin", "R.drawable.yaopin_w"));
        toolsMedTypes.add(new ToolsMedType("鱼肝油", "R.drawable.yaopin", "R.drawable.yaopin_w"));


        toolsMedTypes.add(new ToolsMedType("钙", "R.drawable.yaopin", "R.drawable.yaopin_w"));
        toolsMedTypes.add(new ToolsMedType("铁", "R.drawable.yaopin", "R.drawable.yaopin_w"));
        toolsMedTypes.add(new ToolsMedType("锌", "R.drawable.yaopin", "R.drawable.yaopin_w"));
        toolsMedTypes.addAll(resolveHistoryData(SpUtils.getValue(mContext, SpKey.MED_TMP)));
        ...
        toolsFeedTypeListAdapter.setSaveFlag(true,SpKey.MED_TMP);
        toolsFeedTypeListAdapter.setDialogtitle("输入药物名称");
    ...
    public static ToolsFeedMEDFragment newInstance(Map<String, Object> maporg) {
        ToolsFeedMEDFragment fragment = new ToolsFeedMEDFragment();
    ...
    public void onSucessGetNowDiary(String result) {
        ...
        if(toolsDayNow!=null&&isfragmenthow){
            ...
            if(isNeedNew){
                toolsFeedTypeListAdapter.addData(new ToolsMedType(toolsDayNow.itemName, "R.drawable.zidingyi", "R.drawable.zidingyi_w") );                toolsFeedTypeListAdapter.saveFunction(new ToolsMedType(toolsDayNow.itemName, "R.drawable.zidingyi", "R.drawable.zidingyi_w"),SpKey.SUP_TMP);
                toolsFeedTypeListAdapter.saveFunction(new ToolsMedType(toolsDayNow.itemName, "R.drawable.zidingyi", "R.drawable.zidingyi_w"),SpKey.MED_TMP);
