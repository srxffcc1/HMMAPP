...
public class HanMomVideoFragment extends BaseFragment implements HanMomVideoContract.View {
    ...
    public HanMomVideoFragment() {

    }

    public static HanMomVideoFragment newInstance(String param1, String param2) {
        HanMomVideoFragment fragment = new HanMomVideoFragment();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_han_mom_video;
    }
    ...
    public void getData() {
        super.getData();
        hanMomVideoPresenter.getTabList(new SimpleHashMapBuilder<String, Object>().puts("scope", "0"));
    }
    ...
    private void setTab(final List<VideoCategory> result) {
        ...
        for (int i = 0; i < result.size(); i++) {
            ...
            mFragments.add(HanMomVideoFindChildFragment.newInstance(result.get(i).categoryCode, null));
        }
