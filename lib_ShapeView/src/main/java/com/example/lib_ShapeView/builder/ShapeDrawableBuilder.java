package com.example.lib_ShapeView.builder;
...
import com.example.lib_ShapeView.drawable.ShapeDrawable;
import com.example.lib_ShapeView.drawable.ShapeGradientType;
import com.example.lib_ShapeView.drawable.ShapeType;
import com.example.lib_ShapeView.styleable.IShapeDrawableStyleable;
...
public final class ShapeDrawableBuilder {
    ...
    public ShapeDrawableBuilder setTopLeftRadius(float topLeftRadius) {
        this.mTopLeftRadius = topLeftRadius;
        return this;
    }

    public ShapeDrawableBuilder setTopRightRadius(float topRightRadius) {
        this.mTopRightRadius = topRightRadius;
        return this;
    }

    public ShapeDrawableBuilder setBottomLeftRadius(float bottomLeftRadius) {
        this.mBottomLeftRadius = bottomLeftRadius;
        return this;
    }

    public ShapeDrawableBuilder setBottomRightRadius(float bottomRightRadius) {
