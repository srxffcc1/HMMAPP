...
public class SecondBlockBarnnerAdapter extends BaseAdapter<MainBlockModel> {

    @Override
    public int getItemViewType(int position) {
        return 29;
    }
    public SecondBlockBarnnerAdapter() {
        this(R.layout.item_second_top_banner);
    }
    private SecondBlockBarnnerAdapter(int viewId) {
        super(viewId);
    }
