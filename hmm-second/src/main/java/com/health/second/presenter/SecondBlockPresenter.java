...
public class SecondBlockPresenter implements SecondBlockContract.Presenter {

    private Context mContext;
    private SecondBlockContract.View mView;

    public SecondBlockPresenter(Context context, SecondBlockContract.View view) {
        mContext = context;
        mView = view;
    }
    @Override
        ...
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false) {
                    ...
                    protected void onGetResultSuccess(String obj) {
                        ...
                        mView.onSuccessGetList(resolveTabListData(obj), resolveRefreshData(obj));
                    }
