...
public class ViewTooltip {
    ...
    private FrameLayout toolparent;

    private ViewTooltip(MyContext myContext, View view) {
//        this.view = view;
//        this.tooltip_view = new TooltipView(myContext.getContext());
//        this.rootView=((Activity) tooltip_view.getContext()).getWindow().getDecorView();
//        //System.out.println("确认来删除tool");
//        toolparent = new FrameLayout(myContext.getContext());
//        rootView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
//            @Override
//            public void onFocusChange(View v, boolean hasFocus) {
//                tooltip_view.setVisibility(View.GONE);
//            }
//        });
//        final NestedScrollView scrollParent = findScrollParent(view);
//        if (scrollParent != null) {
//            //System.out.println("判断到华东页面");
...
//        }
    ...
    private ViewTooltip(MyContext myContext, View rootView, View view) {
        this.rootView = rootView != null?rootView:((Activity) myContext.getContext()).getWindow().getDecorView();
        this.view = view;
        this.tooltip_view = new TooltipView(myContext.getContext());
       toolparent = new FrameLayout(myContext.getContext());
        final NestedScrollView scrollParent = findScrollParent(view);
        ...
        if (activityContext != null && activityContext instanceof Activity) {
            ...
            view.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    decorView.addView(toolparent, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
                    toolparent.setOnTouchListener(new View.OnTouchListener() {
                        @Override
                        public boolean onTouch(View v, MotionEvent event) {
                            tooltip_view.setVisibility(View.GONE);
                            toolparent.setVisibility(View.GONE);
                            return false;
                        }
                    });
                    toolparent.addView(tooltip_view, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
