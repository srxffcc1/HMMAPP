...
public class DashboardView extends View {
    ...
    private void initPaint() {
        ...
        paintCenterRingPointer.setColor(getResources().getColor(R.color.white));
        paintCenterRingPointer.setStrokeWidth(mMinCircleRadius);
        paintCenterRingPointer.setStyle(Paint.Style.FILL);//空心画笔
        ...
        paintPointerRight.setColor(Color.parseColor("#F64741"));
        ...
        paintPointerLeft.setColor(Color.parseColor("#F64741"));
...
//        }
    ...
    private void drawerPointer(Canvas canvas, float percent) {
        ...
        pathPointerRight.lineTo(0, (mHight / 2 - OFFSET - progressStrokeWidth)*0.6f);//修改下这个尺寸改小点
        ...
        pathPointerLeft.lineTo(0, (mHight / 2 - OFFSET - progressStrokeWidth)*0.6f);//修改下这个尺寸改小点
    ...
    private void drawInPoint(Canvas canvas) {
        ...
        paintCenterCirclePointer.setColor(getResources().getColor(R.color.white));
