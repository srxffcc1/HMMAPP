 ...
 */
package com.health.tencentlive.like;
...
public class TCHeartLayout extends RelativeLayout {
    ...
    private void findViewById(Context context) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.live_click_like_icon);
    ...
    private static int[] drawableIds = new int[]{R.drawable.like_heart0, R.drawable.like_heart1, R.drawable.like_heart2, R.drawable.like_heart3, R.drawable.like_heart4, R.drawable.like_heart5};
    ...
    public void addFavor() {
        ...
        heartView.setDrawable(mHeartsDrawable[mRandom.nextInt(6)]);
