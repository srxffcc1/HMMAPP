...
public class InviteBottomGoodsAdapter extends BaseMultiItemAdapter<MultiItemEntity> {
    ...
    public void onBindViewHolder(@NonNull BaseHolder baseHolder, final int position) {
        ...
        final RecommendList actGoodsItem = (RecommendList) getDatas().get(position);
