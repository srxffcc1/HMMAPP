...
public class NewStoreDetialPresenter implements NewStoreDetialContract.Presenter {

    private Context mContext;
    private NewStoreDetialContract.View mView;

    public NewStoreDetialPresenter(Context context, NewStoreDetialContract.View view) {
        mContext = context;
        mView = view;
    }
        ...
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false) {
                    ...
                    protected void onGetResultSuccess(String obj) {
                        ...
                        mView.onGetStoreDetialSuccess(resolveDetialData(obj));
                    }
    ...
    public void getCouponList(Map<String, Object> map) {
        map.put(Functions.FUNCTION, "80002");
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new NoStringObserver(mView, mContext, false) {
                    @Override
                    protected void onGetResultSuccess(String obj) {
                        super.onGetResultSuccess(obj);
                        mView.onGetCouponListSuccess(resolveCouponData(obj));
                    }
    ...
    public void getGoodsList(Map<String, Object> map) {
        map.put(Functions.FUNCTION, "9121");
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new NoStringObserver(mView, mContext, false) {
                    @Override
                    protected void onGetResultSuccess(String obj) {
