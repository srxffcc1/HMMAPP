...
interface MallContract2 {
    ...
    interface View : BaseView {
        ...
        fun onGetKKGroupDataSuccess(mallkkmodels: ArrayList<MallKKGroup>?)
...
//        fun onGetTypeDataSuccess(types: ArrayList<TypeModel>?)
    ...
    interface Presenter : BasePresenter {
        ...
        fun getGroupData(cityNo: String, areaNo: String, lat: String, lng: String, page: String,isCurrentCity:String)
    }
}