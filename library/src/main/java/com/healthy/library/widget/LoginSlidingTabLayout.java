 ...
 */
public class LoginSlidingTabLayout extends TabLayout {
    /**
     * 每个tab的宽度
     */
    ...
    public LoginSlidingTabLayout(Context context) {
        super(context);
    }

    public LoginSlidingTabLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mSlideIcon = BitmapFactory.decodeResource(getResources(), R.drawable.login_tabindictor);
