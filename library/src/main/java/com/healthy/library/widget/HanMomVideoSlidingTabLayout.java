 ...
 */
public class HanMomVideoSlidingTabLayout extends TabLayout {
    /**
     * 每个tab的宽度
     */
    ...
    public HanMomVideoSlidingTabLayout(Context context) {
        super(context);
    }

    public HanMomVideoSlidingTabLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mSlideIcon = BitmapFactory.decodeResource(getResources(), R.drawable.hanmom_videolist_tabindictor);
