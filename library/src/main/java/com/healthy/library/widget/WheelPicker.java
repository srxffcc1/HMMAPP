...
public class WheelPicker<T> extends View implements NestedScrollingChild {
        ...
        public void run() {
            ...
            if (mScroller.isFinished() || (mScroller.getFinalY() == mScroller.getCurrY()
                ...
                if (mCurrentPosition != position) {
                    ...
                    setPressed(true);
                    mOnWheelChangeListener.onWheelSelected(WheelPicker.this, mDataList.get(position),
                            position);
                    setPressed(false);
                }
            }
...
//        }
    ...
    public interface OnWheelChangeListener<T> {
        void onWheelSelected(View view, T item, int position);
    }
}
