 ...
 */
public class LiveSlidingTabLayout extends TabLayout {
    /**
     * 每个tab的宽度
     */
     ...
     * 默认的页面可见的tab数量
     */
    private static final int COUNT_DEFAULT_VISIBLE_TAB = 3;
    /**
     * 默认最后一个tab露出百分比
     */
    ...
    public LiveSlidingTabLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mSlideIcon = BitmapFactory.decodeResource(getResources(), R.drawable.live_tabindictor);
        //this.mScreenWidth = getResources().getDisplayMetrics().widthPixels;
        this.mScreenWidth = (int) TransformUtil.dp2px(context, 260);
