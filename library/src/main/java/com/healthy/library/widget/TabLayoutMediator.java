...
public final class TabLayoutMediator {
    ...
    private OnConfigureTabCallback mOnConfigureTabCallback;
    ...
    void populateTabsFromPagerAdapter() {
        ...
        if (mAdapter != null) {
            ...
            for (int i = 0; i < adapterCount; i++) {
                ...
                if (mOnConfigureTabCallback != null) {
    ...
    private class TabLayoutOnPageChangeCallback extends ViewPager2.OnPageChangeCallback {
        ...
        public void onPageSelected(final int position) {
            ...
            if (tabLayout != null
                ...
                if (mOnConfigureTabCallback != null) {
                    mOnConfigureTabCallback.onPageSelected(position);
                }
            }
        }
    ...
    private class ViewPagerOnTabSelectedListener implements TabLayout.OnTabSelectedListener {
        ...
        public void onTabSelected(TabLayout.Tab tab) {
            ...
            if (mOnConfigureTabCallback != null) {
                mOnConfigureTabCallback.onPageSelected(tab.getPosition());
            }
        }
