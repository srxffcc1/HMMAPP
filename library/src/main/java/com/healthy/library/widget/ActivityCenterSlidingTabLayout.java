 ...
 */
public class ActivityCenterSlidingTabLayout extends TabLayout {
    /**
     * 每个tab的宽度
     */
    ...
    public ActivityCenterSlidingTabLayout(Context context) {
        super(context);
    }

    public ActivityCenterSlidingTabLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mSlideIcon = BitmapFactory.decodeResource(getResources(), R.mipmap.activity_center_tabindictor);
