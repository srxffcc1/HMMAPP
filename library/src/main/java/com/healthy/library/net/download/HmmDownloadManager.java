 ...
 * —————————————————————————————————————
 */
public class HmmDownloadManager {

    public final static String FILE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath()+"/HMMPATCH/";
    
    private static final AtomicReference<HmmDownloadManager> INSTANCE = new AtomicReference<>();
    private OkHttpClient mClient;
    private HashMap<String, Call> downCalls; //用来存放各个下载的请求

    public static HmmDownloadManager getInstance() {
        for (; ; ) {
            HmmDownloadManager current = INSTANCE.get();
            if (current != null) {
                return current;
            }
            current = new HmmDownloadManager();
    ...
    private DownloadInfo createDownInfo(String url) {
        ...
        downloadInfo.setFileName("patch_signed_7zip.apk");
        return downloadInfo;
    }
...
//            downloadLength = file.length();
    ...
    private class DownloadSubscribe implements ObservableOnSubscribe<DownloadInfo> {
        ...
        public void subscribe(ObservableEmitter<DownloadInfo> e) throws Exception {
            ...
            System.out.println("下载文件终:"+file.getName());
            InputStream is = null;
