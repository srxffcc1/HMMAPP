package com.healthy.library.audio;
...
import com.healthy.library.utils.VoiceTimeUtils;
...
public class VoiceManager {
    ...
    private long voiceTimeLong = 60L*5;
    /**
     * 录音文件存放的位置(文件夹)
     */
                    ...
                    case MSG_TIME_INTERVAL:
                        if (mDeviceState == MEDIA_STATE_RECORD_DOING) {
                            ...
                            if (voiceRecordCallBack != null) {
                                ...
                                if (mRecTimeSum == voiceTimeLong) {
                                    pauseOrStartVoiceRecord();
                                }
