...
public class GridDropDownPopAll extends PopupWindowCompat {
    RecyclerView rv;
    ...
    public GridDropDownPopAll(Context context, int count, final ItemClickCallBack itemClickCallBack) {
...
//                adapter.notifyDataSetChanged();
    ...
    public GridDropDownPopAll(Context context, final ItemClickCallBack itemClickCallBack) {
