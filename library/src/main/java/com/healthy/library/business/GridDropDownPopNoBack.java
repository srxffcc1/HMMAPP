...
import com.healthy.library.adapter.GridDropDownNoAdapter;
import com.healthy.library.widget.PopupWindowCompat;

import java.util.List;


public class GridDropDownPopNoBack extends PopupWindowCompat {
    RecyclerView rv;
    GridDropDownNoAdapter adapter;
    private View contentView;

    public GridDropDownPopNoBack(Context context, final ItemClickCallBack itemClickCallBack) {
        ...
        adapter = new GridDropDownNoAdapter(R.layout.item_choose_type, new View.OnClickListener() {
            @Override
