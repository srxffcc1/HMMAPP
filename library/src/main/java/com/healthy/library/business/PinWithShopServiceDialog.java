...
public class PinWithShopServiceDialog extends BaseFullBottomSheetFragment implements AppPinContract.View  {
    ...
    public PinWithShopServiceDialog setData(Goods2ShopModelPin.Assemble mGoodsModel, String assembleId) {
...
//                dismiss();
    ...
    public static PinWithShopServiceDialog newInstance() {
        ...
        PinWithShopServiceDialog fragment = new PinWithShopServiceDialog();
