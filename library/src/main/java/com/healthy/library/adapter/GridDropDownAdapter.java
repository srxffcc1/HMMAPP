 ...
 * @description:
 */
public class GridDropDownAdapter extends BaseQuickAdapter<DropDownType, BaseViewHolder> {

    private String selectId = "";
    private View.OnClickListener onClickListener;

    public GridDropDownAdapter() {
        super(R.layout.item_choose_type);
    }



    public GridDropDownAdapter(int layoutResId, View.OnClickListener onClickListener) {
        super(layoutResId);
