...
public class TongLianPhonePresenter implements TongLianPhoneContract.Presenter {

    private Context mContext;
    private TongLianPhoneContract.View mView;

    public TongLianPhonePresenter(Context context, TongLianPhoneContract.View view) {
        mContext = context;
        mView = view;
    }
