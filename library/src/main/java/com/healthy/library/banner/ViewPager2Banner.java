...
public class ViewPager2Banner extends RelativeLayout {
    ...
    public ViewPager2Banner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ViewPager2Banner(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public ViewPager2Banner setPageMargin(int multiWidth, int pageMargin) {
     ...
     * @param pageMargin item与item之间的宽度
     */
    public ViewPager2Banner setPageMargin(int tlWidth, int brWidth, int pageMargin) {
        if (pageMargin < 0) {
            pageMargin = 0;
        }
    ...
    public ViewPager2Banner addPageTransformer(ViewPager2.PageTransformer transformer) {
        compositePageTransformer.addTransformer(transformer);
        return this;
    }

    public ViewPager2Banner setAutoTurningTime(long autoTurningTime) {
        this.autoTurningTime = autoTurningTime;
        return this;
    }

    public ViewPager2Banner setOuterPageChangeListener(ViewPager2.OnPageChangeCallback listener) {
        this.changeCallback = listener;
        return this;
    }

    public ViewPager2Banner setOffscreenPageLimit(int limit) {
     ...
     * 设置viewpager2的切换时长
     */
    public ViewPager2Banner setPagerScrollDuration(long pagerScrollDuration) {
     ...
     */
    public ViewPager2Banner setOrientation(@ViewPager2.Orientation int orientation) {
        viewPager2.setOrientation(orientation);
        return this;
    }

    public ViewPager2Banner addItemDecoration(@NonNull RecyclerView.ItemDecoration decor) {
        viewPager2.addItemDecoration(decor);
        return this;
    }

    public ViewPager2Banner addItemDecoration(@NonNull RecyclerView.ItemDecoration decor, int index) {
     ...
     * 是否自动轮播 大于1页轮播才生效
     */
    public ViewPager2Banner setAutoPlay(boolean autoPlay) {
        isAutoPlay = autoPlay;
     ...
     */
    public ViewPager2Banner setIndicator(Indicator indicator, boolean attachToRoot) {
    ...
    public ViewPager2Banner setRoundCorners(final float radius) {
