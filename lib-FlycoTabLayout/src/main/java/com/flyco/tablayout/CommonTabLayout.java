...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextSelectSize = ta.getDimension(R.styleable.CommonTabLayout_tl_textSelectSize, sp2px(15f));
...
//                //System.out.println("更新update状态为选中:"+position+"|"+tab_title.getText().toString());
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setCurrentTab(int currentTab) {
        if (currentTab >= getTabCount()) {
            currentTab = getTabCount() - 1;//避免超出范围
        }
    ...
    public float getTextSelectSize() { return mTextSelectSize; }
