...
public class IndicatorConfig {
    ...
    private int indicatorSpace = (int) BannerConfig.INDICATOR_SPACE;
    private int normalWidth = (int) BannerConfig.INDICATOR_NORMAL_WIDTH;
    private int selectedWidth = (int) BannerConfig.INDICATOR_SELECTED_WIDTH;
    @ColorInt
