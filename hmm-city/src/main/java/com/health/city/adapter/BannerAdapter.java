...
public class BannerAdapter extends BaseAdapter<String> {
    ...
    private BannerAdapter(int viewId) {
        super(viewId);
    }
    ...
    public void onBindViewHolder(@NonNull BaseHolder baseHolder, int i) {
         Banner actBanner;
        actBanner = (Banner) baseHolder.itemView.findViewById(R.id.mall_banner);
            ...
            banner.setOnBannerListener(new OnBannerListener() {
                ...
                public void OnBannerClick(Object data, int position) {
                    ...
                    if (moutClickListener != null) {
                        moutClickListener.outClick("banner", bannerimgs.get(position).id);
                    }
