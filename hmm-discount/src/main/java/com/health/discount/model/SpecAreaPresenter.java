...
public class SpecAreaPresenter implements SpecAreaContract.Presenter {
    private Context mContext;
    private SpecAreaContract.View mView;

    public SpecAreaPresenter(Context context, SpecAreaContract.View view) {
        mContext = context;
        mView = view;
    }
        ...
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false) {
                    ...
                    protected void onGetResultSuccess(String obj) {
                        ...
                        mView.onSucessGetList(resolveTabListData(obj), resolveRefreshData(obj));
                    }
    ...
    @Override
    public void getThemeDetial(Map<String, Object> map) {
        map.put(Functions.FUNCTION, "101009");
        map.put("shopId", SpUtils.getValue(mContext, SpKey.CHOSE_SHOP));
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false) {
                    @Override
                    protected void onGetResultSuccess(String obj) {
                        ...
                        mView.successThemeDetial(resolveBloclDetailData(obj));
                    }
    ...
    private MainBlockModel resolveBloclDetailData(String obj) {
        MainBlockModel result = null;
        try {
            JSONObject data = new JSONObject(obj).getJSONObject("data");
            String userShopInfoDTOS = data.toString();
            GsonBuilder builder = new GsonBuilder();
            ...
            Gson gson = builder.create();
            Type type = new TypeToken<MainBlockModel>() {
            }.getType();
            result = gson.fromJson(userShopInfoDTOS, type);
        } catch (JSONException e) {
            e.printStackTrace();
    ...
    private List<MainBlockDetailModel> resolveTabListData(String obj) {
