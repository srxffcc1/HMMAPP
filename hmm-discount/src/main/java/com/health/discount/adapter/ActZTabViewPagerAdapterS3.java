...
public class ActZTabViewPagerAdapterS3 extends BaseAdapter<MultiItemEntity> {
    ...
    public ActZTabViewPagerAdapterS3() {
        this(R.layout.item_mall_goods_city);

    }
    private ActZTabViewPagerAdapterS3(int viewId) {
        super(viewId);
    }
