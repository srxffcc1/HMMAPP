...
public class NewUserListPresenter implements NewUserListContract.Presenter {
    private Context mContext;
    private NewUserListContract.View mView;

    public NewUserListPresenter(Context context, NewUserListContract.View view) {
        mContext = context;
        mView = view;
    }
                ...
                .subscribe(new StringObserver(mView, mContext, false) {
                    ...
                    protected void onGetResultSuccess(String obj) {
                        ...
                        if(!"1".equals(map.get("historyQuery"))&&list.size()<=0){
                            getList(new SimpleHashMapBuilder<String, Object>().putMap(map).puts("marketingId",null).puts("historyQuery","1"));
                            return;
                        }
