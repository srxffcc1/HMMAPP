...
public class ActCitySecondBlockPresenter implements ActCityBuySecondBlockContract.Presenter {
    private Context mContext;
    private ActCityBuySecondBlockContract.View mView;

    public ActCitySecondBlockPresenter(Context context, ActCityBuySecondBlockContract.View view) {
        mContext = context;
        mView = view;
    }
        ...
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false) {
                    ...
                    protected void onGetResultSuccess(String obj) {
                        ...
                        mView.onSucessGetCityGoodsList(resolveActSortGoodsData(obj),resolveRefreshData(obj));
                    }
                    ...
                    protected void onFailure() {
                        super.onFailure();
                        mView.onSucessGetCityGoodsList(null,null);
                    }
                });
    }
