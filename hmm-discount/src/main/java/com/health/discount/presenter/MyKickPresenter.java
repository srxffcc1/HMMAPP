...
public class MyKickPresenter implements MyKickContract.Presenter {
    private Context mContext;
    private MyKickContract.View mView;

    public MyKickPresenter(Context context, MyKickContract.View view) {
        mContext = context;
        mView = view;
    }
    ...
    public void getKickTopList(Map<String, Object> map) {
        map.put(Functions.FUNCTION, "7052");
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false) {
                    @Override
                    protected void onGetResultSuccess(String obj) {
                        super.onGetResultSuccess(obj);
                        mView.onSuccessGetTopKickList(resolveKickListData(obj), resolveRefreshData(obj));
                    }
    ...
    private List<MyKickList> resolveKickListData(String obj) {
        List<MyKickList> result = new ArrayList<>();
        try {
            ...
            Type type = new TypeToken<List<MyKickList>>() {
            }.getType();
