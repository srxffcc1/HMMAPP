...
public class NewKickListPresenter implements NewKickListContract.Presenter {
    private Context mContext;
    private NewKickListContract.View mView;

    public NewKickListPresenter(Context context, NewKickListContract.View view) {
        mContext = context;
        mView = view;
    }
        ...
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false) {
                    ...
                    protected void onFailure() {
                        super.onFailure();
                        mView.onSuccessGetKickList(null, null);
    ...
    public void getKickTopList(Map<String, Object> map) {
        ...
        ObservableHelper.createObservable(mContext, map)
                .subscribe(new StringObserver(mView, mContext, false) {
                    ...
                    protected void onGetResultSuccess(String obj) {
                        super.onGetResultSuccess(obj);
                        mView.onSuccessGetTopKickList(resolveKickListDataNoPage(obj), null);
                    }
