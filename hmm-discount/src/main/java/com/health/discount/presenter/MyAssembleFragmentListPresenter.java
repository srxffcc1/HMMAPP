...
import com.health.discount.contract.MyAssenbleFragmentListContract;
...
public class MyAssembleFragmentListPresenter implements MyAssenbleFragmentListContract.Presenter{
    private Context mContext;
    private MyAssenbleFragmentListContract.View mView;

    public MyAssembleFragmentListPresenter(Context context, MyAssenbleFragmentListContract.View view) {
        mContext = context;
        mView = view;
    }
