...
public class CouponCommonFragment extends BaseFragment implements CouponVipListContract.View {
...
//    CouponChildFragment couponChildRightFragment;
    ...
    public static CouponCommonFragment newInstance(Map<String, Object> maporg) {
        CouponCommonFragment fragment = new CouponCommonFragment();
    ...
    public void getData() {
        ...
        mTitles.add("商家券");
//        mTitles.add("平台券");
        couponChildLeftFragment= CouponChildFragment.newInstance(new SimpleHashMapBuilder().puts("type",get("type")).puts("couponType","3").puts("status",get("status")));
//        couponChildRightFragment= CouponChildFragment.newInstance(new SimpleHashMapBuilder().puts("type",get("type")).puts("couponType","3").puts("status",get("status")));
