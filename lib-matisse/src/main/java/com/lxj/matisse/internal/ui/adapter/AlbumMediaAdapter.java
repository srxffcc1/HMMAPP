...
public class AlbumMediaAdapter extends
    ...
    protected void onBindViewHolder(final RecyclerView.ViewHolder holder, Cursor cursor) {
        if (holder instanceof CaptureViewHolder) {
            ...
            final Drawable carmerad = holder.itemView.getContext().getResources().getDrawable(R.drawable.ic_photo_camera_white_24dp);
            final Drawable videod = holder.itemView.getContext().getResources().getDrawable(R.drawable.ic_photo_video_white_24dp);
            if(SelectionSpec.getInstance().captureMode== CaptureMode.Image){
                captureViewHolder.mHint.setText(R.string.photo_grid_capture);
            }else if(SelectionSpec.getInstance().captureMode== CaptureMode.Video){
                captureViewHolder.mHint.setText(R.string.photo_grid_video);
            }else {
                captureViewHolder.mHint.setText(R.string.photo_grid_capture);
            }
            ...
            captureViewHolder.mHint.setCompoundDrawablesWithIntrinsicBounds(drawables[0], drawables[1], drawables[2], drawables[3]);
